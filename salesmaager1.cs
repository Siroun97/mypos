...
internal class salesmaager1
{
    ...
    public salesmaager1(string username, DateTime saleDate, decimal totalAmount, List<SaleItem1> items)
    {
    ...
    {
        string insertQuery = "INSERT INTO Sales (UserID, SaleDate, TotalAmount) VALUES (@UserID, @SaleDate, @TotalAmount); SELECT SCOPE_IDENTITY();";
    ...
    private void InsertSaleItems2(int saleId, List<SaleItem1> items, SqlConnection connection, SqlTransaction transaction)
    {
        foreach (var item in items)
        {
            string insertItemQuery = "INSERT INTO SaleItems (SaleID, ProductID, Quantity, Subtotal) VALUES (@SaleID, @ProductID, @Quantity, @Subtotal)";
